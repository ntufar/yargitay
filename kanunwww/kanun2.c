...
static unsigned long sqlctx = 37291;
...
extern void sqliem(/*_ char *, int * _*/);
 ...
 static char *sq0002 = 
"select madde ,count(madde)  from emsal.kanun where kanun=:b0 group by madde \
order by madde            ";

 static char *sq0003 = 
"select madde ,count(madde)  from emsal.kanun where (daireno=:b0 and kanun=:b\
1) group by madde order by madde            ";
...
{10,4146,0,0,0,
5,0,0,1,0,0,27,139,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,5,0,0,1,10,0,0,
36,0,0,2,102,0,9,185,0,0,1,1,0,1,0,1,5,0,0,
55,0,0,3,120,0,9,187,0,0,2,2,0,1,0,1,5,0,0,1,5,0,0,
78,0,0,2,0,0,13,194,0,0,2,0,0,1,0,2,5,0,0,2,3,0,0,
101,0,0,3,0,0,13,197,0,0,2,0,0,1,0,2,5,0,0,2,3,0,0,
124,0,0,3,0,0,15,213,0,0,0,0,0,1,0,
139,0,0,2,0,0,15,215,0,0,0,0,0,1,0,
};
