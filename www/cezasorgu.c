...
static unsigned long sqlctx = 291123;
...
36,0,0,2,0,0,17,208,0,0,1,1,0,1,0,1,5,0,0,
55,0,0,2,0,0,45,218,0,0,0,0,0,1,0,
70,0,0,2,0,0,13,225,0,0,14,0,0,1,0,2,5,0,0,2,5,0,0,2,3,0,0,2,5,0,0,2,5,0,0,2,5,
0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,5,0,0,2,5,0,0,2,5,0,0,2,5,0,0,2,3,0,0,
141,0,0,3,143,0,4,249,0,0,5,1,0,1,0,2,5,0,0,2,5,0,0,2,3,0,0,2,5,0,0,1,3,0,0,
176,0,0,2,0,0,15,345,0,0,0,0,0,1,0,
};
...

{
 ...
 sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	if(SQL_NOTFOUND){
		if(firsttime){
			cgiPrintf("<p>Hiçbir kayýt bulunamadý<p>");
		}
		break;
	}
	firsttime = 0;
	if(p_kararsonucu == 0){
       ...
       /o         kararsonucu.daireno = :daireno AND
...
listarihi into :b0:b1,:b2:b3,:b4:b5,:b6:b7  from ceza.kararsonucu where karars\
onucu.id=:b8";
        sqlstm.iters = (unsigned int  )1;
	...
	"<tr><td><td><b>Geldiði Tarih	</b></td><td>%s</td></tr>"
	"<tr><td><td><b>Teblið Tarihi	</b></td><td>%s</td></tr>"
	"<tr><td><td><b>Teblið Masasý	</b></td><td>%s</td></tr>"
	"<tr><td><td><b>Teblið Numarasý	</b></td><td>%s</td></tr>"
	"<tr><td><td><b>Esas No		</b></td><td>%s</td></tr>"
	"<tr><td><td><b>Karar No	</b></td><td>%s</td></tr>"
	"<tr><td><td><b>Gönderen mahkeme</b></td><td>%s</td></tr>"
	"<tr><td><td><b>Sucun türü	</b></td><td>%s</td></tr>"
